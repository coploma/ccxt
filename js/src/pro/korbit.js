...
export default class korbit extends korbitRest {
    ...
    async watchTicker(symbol, params = {}) {
        return await this.watchPrivate(symbol, 'ticker');
    }
    /**
     * @method
     * @name korbit#watchTicker
    ...
    async watchTickers(symbols = undefined, params = {}) {
        const newTickers = await this.watchPrivateMultiple(symbols, 'ticker');
        if (this.newUpdates) {
            const tickers = {};
    ...
    async watchTradesForSymbols(symbols, since = undefined, limit = undefined, params = {}) {
        ...
        const trades = await this.watchPrivateMultiple(url, messageHashes, request, messageHashes);
        if (this.newUpdates) {
    ...
    async watchOrderBook(symbol, limit = undefined, params = {}) {
        const orderbook = await this.watchPrivate(symbol, 'orderbook');
